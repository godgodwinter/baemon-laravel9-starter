...
<x-jstooltip/>
    ...
    <form id="setting-form" method="POST" action="{{route('dev.crud.store')}}">
        @csrf
        ...
        <div class="form-group row align-items-center py-2">
          ...
          <div class="form-group row align-items-center py-2">
              ...
              <div class="col-sm-6 col-md-9">
                ...
                <input type="text" class="form-control  @error('prefix') is-invalid @enderror" name="prefix" required  value="{{old('prefix')}}">
            ...
            <div class="form-group row align-items-center py-2">
                ...
                <div class="col-sm-6 col-md-9">
                  ...
                  <input type="text" class="form-control  @error('kode') is-invalid @enderror" name="kode" required  value="{{old('kode')}}">
